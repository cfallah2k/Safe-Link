        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3 min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
              <h1 className="text-lg sm:text-xl font-bold text-white truncate">Visual Accessibility</h1>
              <p className="text-sm text-white/80 truncate">
                Features designed for users with visual impairments
              </p>
            </div>
          </div>
          <div className="flex items-center space-x-2 flex-shrink-0">
            <button
              onClick={() => speakText('Visual Accessibility page loaded. This page provides features for users with visual impairments.')}
